...
public class RecyclerAdapter extends RecyclerView.Adapter<RecyclerAdapter.CountryViewHolder> {
    ...
    public void onBindViewHolder(@NonNull CountryViewHolder holder, @SuppressLint("RecyclerView") int position) {
        ...
        holder.cardView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (position == 0){
                    Toast.makeText(context, "Voce selecionou a bandeira do Brazil",Toast.LENGTH_SHORT).show();
                }else   if (position == 1){
                    Toast.makeText(context, "Voce selecionou a bandeira da Irlanda",Toast.LENGTH_SHORT).show();
                }else   if (position == 2){
                    Toast.makeText(context, "Voce selecionou a bandeira da Belgica",Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
    ...
    public class CountryViewHolder extends RecyclerView.ViewHolder {
        ...
        public CountryViewHolder(@NonNull View itemView) {
            ...
            textViewCountryName = itemView.findViewById(R.id.tv_countryName);
            textViewDetails = itemView.findViewById(R.id.tv_detail);
